...
public class StartupClientOnly
{
  ...
  public static void initClientOnly()
  {
    ...
    Item itemBlockSimple = GameRegistry.findItem("mbe01_block_simple", "mbe01_block_simple");
    
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("mbe01_block_simple:mbe01_block_simple", "inventory");
