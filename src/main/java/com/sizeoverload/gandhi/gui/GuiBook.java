package com.sizeoverload.gandhi.gui;
...
import com.sizeoverload.gandhi.Main;
...
public GuiBook()
{
    ...
    bookPageTextures[0] = new ResourceLocation(Main.MODID+":textures/gui/book.png");
    stringPageText[0] = "Gandhi";
    //    stringPageText[0] = "This is your "+Utilities.stringToRainbow("Family Cow", true) +". but she no longer produces any milk.\n\nSo you mother told you that you had to take the cow and find a villager to sell her to.\n\nShe handed you a lead and said 'Take the cow to town.  And make sure you get a good deal!'.";
}
